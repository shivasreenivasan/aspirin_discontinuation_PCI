...
forest_plot <- ggplot(forest_data, aes(y = study)) +
  ...
  annotate("text",
    x = 0.15, y = 0.5, label = "Favours CA",
    size = 3.3, fontface = "italic", colour = "#0072B2"
  ) +
  annotate("text",
    x = 3.5, y = 0.5, label = "Favours MT",
...
posterior_mu_plot <- posterior_data |>
  ...
  geom_vline(xintercept = 1, linetype = "dashed", linewidth = 1, colour = "white") +
  geom_vline(
